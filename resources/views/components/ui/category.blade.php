...
<div
    tabindex="0" 
    class="group bg-[#F2F9FBBF] cursor-pointer text-[#004972] font-normal poetsen-one-regular py-5 px-6 rounded-xl transition-all duration-300 hover:bg-[#004972] hover:text-[#F2F9FB] focus:bg-[#004972] focus:text-[#F2F9FB] outline-none {{ $class }}" 
>
    <a href="{{ route('categoryPage', ['catId' => $id]) }}" class="flex items-center gap-2">
